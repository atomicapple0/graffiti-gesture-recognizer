...
class Grafitti {
public static int n; //num points in processed template/input
public static int dimen; //width of bounding box
public static ArrayList<Point>[] templates;
public static ArrayList<Point> points_input;
public static ArrayList<Point> points_processed;
...
public static ArrayList<Point> resample(ArrayList<Point> points_input) {
    return resample(points_input, Grafitti.n);
}
